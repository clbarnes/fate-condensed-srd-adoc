...
make characters—also called PCs. Each player
...
[%header, format=tsv]
|===
include::../table/adjective_ladder.tsv[]
|===
...
*Stress* and *consequences* are how your
...
[%header, format=tsv]
|===
include::../table/stress_and_consequences.tsv[]
|===
